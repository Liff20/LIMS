...
@section('title', 'Detail Alat Bahan Masuk')
@section('page-title', 'Detail Alat Bahan Masuk')
@section('page-subtitle', 'Laporan penerimaan / barang masuk')

@section('content')
    <div class="card p-5">
        <div class="mb-4 flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
            <h3 class="section-title">Laporan Alat & Bahan Masuk</h3>
                ...
                <tbody>
                    @forelse ($items as $i => $row)
                        <tr>
                            ...
                            <td class="text-right font-semibold">Rp {{ number_format($row['total'], 0, ',', '.') }}</td>
                        </tr>
                    @empty
